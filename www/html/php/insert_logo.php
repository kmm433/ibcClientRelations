...
/*
        ...
        $imagetmp=addslashes(file_get_contents($_FILES['image']["name"]));

        //Insert the image name and image content in image_table
        $query="INSERT INTO LOGO VALUES('$imagename', '$imagetmp', $chamber)";
    ...
    */
    ...
    $image_name=$chamber.'logo'.'.'.$extension;
    ...
    //If no errors registred, print the success message
     ...
     {
        $query="INSERT INTO LOGO (name, chamberID) VALUES('$image_name', $chamber)";
